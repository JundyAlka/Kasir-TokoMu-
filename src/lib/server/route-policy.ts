...
export const routePolicy: Record<string, RoutePolicy> = {
  ...
  "/api/debts/import": { POST: ALL_ROLES },
  ...
  "/api/investors/import-titipan/preview": { POST: FINANCE_ROLES },
  "/api/investors/import-titipan/commit": { POST: FINANCE_ROLES },
  ...
  "/api/transactions/[id]": { DELETE: LEADERSHIP_ONLY },
