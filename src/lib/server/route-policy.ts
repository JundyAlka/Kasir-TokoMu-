...
export const routePolicy: Record<string, RoutePolicy> = {
  ...
  "/api/expenses": { GET: FINANCE_ROLES, POST: FINANCE_ROLES },
  ...
  "/api/reports/assets": { GET: FINANCE_ROLES },
  "/api/reports/monthly": { GET: FINANCE_ROLES, POST: FINANCE_ROLES },
  ...
  "/api/reports/profit-loss": { GET: FINANCE_ROLES },
  "/api/reports/profit-loss/pdf": { GET: FINANCE_ROLES },
  "/api/restock/batch": { POST: ALL_ROLES },
  "/api/restock/history": { GET: ALL_ROLES },
  "/api/restock-plans": { GET: FINANCE_ROLES, POST: FINANCE_ROLES, PATCH: FINANCE_ROLES },
  ...
  "/api/users/[id]": { DELETE: LEADERSHIP_ONLY },
