...
const navigation = [
  ...
  { href: "/laporan", label: "Laporan", icon: ScrollText, roles: ["pimpinan", "pengelola_keuangan"] },
  ...
  return (
    <div className="h-screen overflow-hidden bg-background">
      <div className="mx-auto flex h-full w-full max-w-[1600px] gap-3 p-3 lg:gap-4 lg:p-5">
        ...
        <AIAssistantPanel open={aiOpen} onOpenChange={handleAiOpenChange} />
      </div>
    </div>
  );
}
